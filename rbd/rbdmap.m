...
% SRC = 'C:\Users\liyangzhong\Desktop\实验\实验结果\缝裁剪和快缩放\temp';       %Path of input images
% BDCON = 'C:\Users\liyangzhong\Desktop\实验\实验结果\缝裁剪和快缩放\BDCON';   %Path for saving bdCon feature image
% RES = 'C:\Users\liyangzhong\Desktop\实验\实验结果\缝裁剪和快缩放\tempsal';       %Path for saving saliency maps
% srcSuffix = '.bmp';     %suffix for your input image
...
rbd = SaveSaliencyMap(optwCtr, pixelList, frameRecord, true);
%figure();imshow(rbd);title("rbd");
